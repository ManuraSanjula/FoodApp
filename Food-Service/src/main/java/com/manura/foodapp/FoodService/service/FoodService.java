...
public interface FoodService {
	    Flux<FoodDto> findAll(int page,int size);
	    Flux<CommentsDto> findAllComment(String foodId);
	    Flux<FoodDto> findByTypeAndName(String type, String name,int page,int size);
	    Flux<FoodDto> findByNames(String name,int page,int size);
	    Flux<FoodDto> findByType(String type,int page,int size);
