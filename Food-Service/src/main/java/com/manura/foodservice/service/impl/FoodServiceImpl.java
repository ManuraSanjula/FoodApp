package com.manura.foodservice.service.impl;

import com.manura.foodservice.dto.CommentsDto;
import com.manura.foodservice.dto.FoodDto;
import com.manura.foodservice.dto.FoodHutDto;
import com.manura.foodservice.entity.CommentsEntity;
...
import com.manura.foodservice.messaging.Pub;
import com.manura.foodservice.repo.FoodHutRepo;
import com.manura.foodservice.repo.FoodRepo;
import com.manura.foodservice.repo.UserRepo;
import com.manura.foodservice.service.FoodService;
import com.manura.foodservice.util.ErrorMessages;
...
public class FoodServiceImpl implements FoodService {
    ...
    public Mono<FoodHutDto> saveFoodHut(Mono<FoodHutDto> foodHut) {
        return foodHut.map(i -> modelMapper.map(i, FoodHutEntity.class)).map(i -> {
            return i;
        }).flatMap(foodHutRepo::insert).map(i -> modelMapper.map(i, FoodHutDto.class))
