...
public class AmazonSES {
	...
	final String SUBJECT = "One last step to complete your registration with Food Example App";

	final String PASSWORD_RESET_SUBJECT = "Password reset request";

	private String canonicalHostName = "localhost";
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
			...
			+ " click on the following link: " + "<a href='http://" + canonicalHostName
			+ "/users/emailVerify-WebPage?token=$tokenValue'>" + "Final step to complete your registration"
			+ "</a><br/><br/>" + "Thank you! And we are waiting for you inside!";

	// The email body for recipients with non-HTML email clients.
	final String TEXTBODY = "Please verify your email address. "
			+ "Thank you for registering with our mobile app. To complete registration process and be able to log in,"
			+ " open then the following URL in your browser window: " + " http://" + canonicalHostName
			+ "/users/emailVerify-WebPage?token=$tokenValue" + " Thank you! And we are waiting for you inside!";

	final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>" + "<p>Hi, $firstName!</p> "
			+ "<p>Someone has requested to reset your password with our project. If it were not you, please ignore it."
			+ " otherwise please click on the link below to set a new password: " + "<a href='http://"
			+ canonicalHostName + "/users/passwordReset-WebPage?token=$tokenValue'>"
	...
	final String PASSWORD_RESET_TEXTBODY = "A request to reset your password " + "Hi, $firstName! "
			...
			+ " otherwise please open the link below in your browser window to set a new password:" + " http://"
			+ canonicalHostName + "/users/passwordReset-WebPage?token=$tokenValue" + " Thank you!";
